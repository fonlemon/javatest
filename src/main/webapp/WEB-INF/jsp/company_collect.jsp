...
<div class="PerBody">
    ...
    <div class="Per-left" id="Per-left">
        <h3>账户管理</h3>
        <ul>
            <li><a href="发布者-个人中心.html">基本信息</a></li>
            <li> <a href="发布者-个人中心.html">实名认证</a></li>
            <li><a href="发布者-个人中心.html">信息修改</a></li>
        </ul>
        <h3>发布任务</h3>
        <ul>
            <li><a href="company_collect">收藏的公司</a></li>
            <li><a href="task_send">已发布的任务</a></li>
    ...
    <div class="Per-right">
        <div class="right-top" id="order">
            <div>
                <span>排序:</span>
                <a  onclick="order(0)">评价</a>
                <a  onclick="order(1)">收藏时间</a>
            </div>
            <label>
                <input type="text"  placeholder="公司搜索">
        ...
        <div class="right-mid">
            <div class="task-message">
                <div class="task-message-Exhibition">
                    ...
                    <div class="task-message-Exhibition-text">阿里巴巴</div>
                    <div class="task-message-Exhibition-evaluate">评价：<i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star-half"></i></div>
                ...
                <div class="task-message-Exhibition">
                    <a href="#"><img src="img/company.png"></a>
                    <div class="task-message-Exhibition-text">阿里巴巴</div>
                    <div class="task-message-Exhibition-evaluate">评价：<i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star-o"></i><i class="fa fa-star-o"></i></div>
                    <div class="task-message-Exhibition-time">
                        <a>收藏时间：<span>2016-12-30</span></a>
                    </div>
                </div>
                <div class="task-message-Exhibition">
                    <a href="#"><img src="img/company.png"></a>
                    <div class="task-message-Exhibition-text">阿里巴巴</div>
                    <div class="task-message-Exhibition-evaluate">评价：<i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star-half"></i><i class="fa fa-star-o"></i><i class="fa fa-star-o"></i></div>
                    <div class="task-message-Exhibition-time">
                        <a>收藏时间：<span>2016-12-30</span></a>
                    </div>
                </div>
                ...
                <div class="task-message-Exhibition">
                    <a href="#"><img src="img/company.png"></a>
                    <div class="task-message-Exhibition-text">阿里巴巴</div>
                    <div class="task-message-Exhibition-evaluate">评价：<i class="fa fa-star"></i><i class="fa fa-star-o"></i><i class="fa fa-star-o"></i><i class="fa fa-star-o"></i><i class="fa fa-star-o"></i></div>
                    <div class="task-message-Exhibition-time">
                        <a>收藏时间：<span>2016-12-30</span></a>
                    </div>
                </div>
...
<script type="text/javascript">
    ...
    function order(indenx){
        ...
        if(indenx==0){
            ...
            switch (i_piece){
                case 0:a_order[indenx].innerHTML="评价<i class='fa fa-sort-asc'></i>";i_piece++;break;
                case 1:a_order[indenx].innerHTML="评价<i class='fa fa-sort-desc'></i>";i_piece++;break;
                default :i_piece=0;order(indenx);break;
            }
        }
        if(indenx==1){
            i_piece=-0;
            a_order[0].innerHTML="评价";
            switch (i_time){
