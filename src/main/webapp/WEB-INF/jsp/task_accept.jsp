...
<script type="text/javascript">
    ...
    function order(indenx){
        ...
        if(indenx==1){
            ...
            switch (i_time){
                case 0:a_order[indenx].innerHTML="接受时间<i class='fa fa-sort-asc'></i>";i_time++;break;
                case 1:a_order[indenx].innerHTML="接受时间<i class='fa fa-sort-desc'></i>";i_time++;break;
