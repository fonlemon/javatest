        ...
        <div class="right-mid">
            <div class="task-message">
                <div class="task-message-Exhibition">
                    <a href="#"><img src="img/Exhibition-pic.png"></a>
                    <div class="task-message-Exhibition-text">VI设计  VIS设计  企业VI设计....</div>
                    <div class="task-message-Exhibition-price"><a href="#">¥：200880</a></div>
                    <div class="task-message-Exhibition-time">
                        <a>完成时间：<span>2016-12-30</span></a>
                    </div>
                </div>
                <div class="task-message-Exhibition">
                    <a href="#"><img src="img/Exhibition-pic.png"></a>
...
<script type="text/javascript">
    ...
    function order(indenx){
        ...
        if(indenx==1){
            ...
            switch (i_time){
                case 0:a_order[indenx].innerHTML="完成时间<i class='fa fa-sort-asc'></i>";i_time++;break;
                case 1:a_order[indenx].innerHTML="完成时间<i class='fa fa-sort-desc'></i>";i_time++;break;
